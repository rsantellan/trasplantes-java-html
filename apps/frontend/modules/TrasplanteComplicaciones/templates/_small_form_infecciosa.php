...
<?php echo $form->renderGlobalErrors(); ?>
  ...
  <div class="form_block">
	<h4><?php echo __("trasplanteComplicacion_Infeccion");?></h4>
	<div class="form_block_field<?php if($form['infeccion_id']->hasError()):?> error_msg<?php endif; ?>">
	  <?php echo $form['infeccion_id']->render() ?>
	</div>
	<a href="javascript:void(0)" class="simple_tip_container" onclick="return complicacionesManagement.getInstance().showInfeccionManagement('<?php echo url_for("@manejarComplicacionInfeccion");?>');">
      <?php echo image_tag("add_block.png", array("width" => 24)); ?>
	...
	<div>
		...
		if($form['infeccion_id']->hasError()): 
		?>  
	  <div class="clear"></div>
		<?php
		  $msg_error = __("trasplanteComplicacion_tipo de complicacion").': '.__("trasplanteComplicacion_error ".$form['infeccion_id']->getError());
		  echo $msg_error;  
		endif; 
		?>
	</div>
  ...
  <div class="form_block">
	<h4><?php echo __("trasplanteComplicacion_Germen");?></h4>
	<div class="form_block_field<?php if($form['germen_id']->hasError()):?> error_msg<?php endif; ?>">
	  <?php echo $form['germen_id']->render() ?>
	</div>
	<a href="javascript:void(0)" class="simple_tip_container" onclick="return complicacionesManagement.getInstance().showGermenManagement('<?php echo url_for("manejarComplicacionGermen");?>');">
      <?php echo image_tag("add_block.png", array("width" => 24)); ?>
      <div class="tooltip_text"><?php echo __("donante_manejar causa muerte");?></div>		
    </a>
	...
	<div>
		...
		if($form['germen_id']->hasError()): 
		?>  
	  <div class="clear"></div>
		<?php
		  $msg_error = __("trasplanteComplicacion_tipo de complicacion").': '.__("trasplanteComplicacion_error ".$form['germen_id']->getError());
		  echo $msg_error;  
		endif; 
		?>
	</div>
