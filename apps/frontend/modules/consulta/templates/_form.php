...
<?php endif; ?>
  <table>
    <tfoot>
      <tr>
        <td colspan="2">
          ...
          &nbsp;<a href="<?php echo url_for('consulta/index') ?>">Back to list</a>
          <?php if (!$form->getObject()->isNew()): ?>
    ...
    <tbody>
      ...
      <tr>
        <th><?php echo $form['sentencia']->renderLabel() ?></th>
        <td>
          <?php echo $form['sentencia']->renderError() ?>
          <?php echo $form['sentencia'] ?>
        </td>
      </tr>
    </tbody>
  </table>
