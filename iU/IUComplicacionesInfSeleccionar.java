...
public class IUComplicacionesInfSeleccionar extends JFrame implements java.util.Observer{
	...
	private void cargarDatos(){
		ModeloDatosListaComplicacionesInf md = new ModeloDatosListaComplicacionesInf(lista);
	...
	private void agregar(){
		IUComplicacionesInfInsertar iuInsertar = new IUComplicacionesInfInsertar(this.the,this.esTrasplante);
	...
	private void modificarComplicacion(){
		...
		if(t != null){
			IUComplicacionesInfVerModificar iuModificar = new IUComplicacionesInfVerModificar(t,false);
	...
	private void ver(){
		...
		TrasplanteComplicacionesInf t = this.lista.get(fila);
		if(t != null){
			IUComplicacionesInfVerModificar iuModificar = new IUComplicacionesInfVerModificar(t,true);
			iuModificar.setVisible(true);
		}
	}
	...
	private void eliminar(){
		...
		if(t != null){
			String respuesta = "";
			respuesta = JOptionPane.showInputDialog(this, "Está a punto de eliminar una complicacion infecciosa\n(Ingrese SI para eliminar) Confirmar: ", "Confirmar", 1);
