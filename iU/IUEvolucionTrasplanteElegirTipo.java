...
public class IUEvolucionTrasplanteElegirTipo extends JFrame implements
	...
	private void otrosExamenes(){
		IUEvolucionExamenesManejar otrosExamenes = new IUEvolucionExamenesManejar(this.t.getId(),this.fecha);
	...
	private void ecodopler(){
		IUEvolucionEcoDoplerManejar eco = new IUEvolucionEcoDoplerManejar(this.t.getId(), this.fecha);
		eco.setVisible(true);
	}
	...
	private void ecografia(){
		IUEvolucionEcografiaManejar eco = new IUEvolucionEcografiaManejar(this.t.getId(), this.fecha);
		eco.setVisible(true);
	}
