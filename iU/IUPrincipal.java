...
import iUConsultas.IUConsultaGenericaOpciones;
import iUConsultas.IUConsultaGermenInfeccion;
import iUConsultas.IUConsultaMenuLineal;
import iUConsultas.IUConsultaXCausaMuerteDonante;
...
public class IUPrincipal extends JFrame implements java.util.Observer {
	...
	private JMenu jMenuTrasplantes = null;
	private JMenuItem jMenuItemManejarTrasplantes = null;
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabelPacientes.setBounds(new Rectangle(7, 73, 267, 28));
	...
	private JMenuBar getJJMenuBar() {
		if (jJMenuBar == null) {
			...
			jJMenuBar.add(getJMenuTrasplantes());
	...
	/**
	 * This method initializes jMenuTrasplantes
	 * 
	 * @return javax.swing.JMenu
	 */
	private JMenu getJMenuTrasplantes() {
		if (jMenuTrasplantes == null) {
			jMenuTrasplantes = new JMenu();
			jMenuTrasplantes.setText("Trasplantes");
			jMenuTrasplantes.add(getJMenuItemManejarTrasplantes());
		}
		return jMenuTrasplantes;
	}

	/**
	 * This method initializes jMenuItemManejarTrasplantes
	 * 
	 * @return javax.swing.JMenuItem
	 */
	private JMenuItem getJMenuItemManejarTrasplantes() {
		if (jMenuItemManejarTrasplantes == null) {
			jMenuItemManejarTrasplantes = new JMenuItem();
			jMenuItemManejarTrasplantes.setText("Manejar Trasplantes");
			jMenuItemManejarTrasplantes
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
							manejarTrasplantes();
						}
		...
		return jMenuItemManejarTrasplantes;
	}

	private void manejarTrasplantes() {
		IUTrasplanteSeleccionar iuTraSeleccionar = new IUTrasplanteSeleccionar();
		iuTraSeleccionar.setVisible(true);
	}
	...
	private void menejarInfecciones() {
	...
	private void crearBackUp(){
		IUBackUpProgress backUp = new IUBackUpProgress(this);
	...
	private void restoreBackUp(){
		IUBackUpRestoreProgress restore = new IUBackUpRestoreProgress(this);
