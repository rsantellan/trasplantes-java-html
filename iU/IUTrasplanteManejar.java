...
public class IUTrasplanteManejar extends JFrame {
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			jLabelAnastUterial.setText("Anast Uterial :");
			...
			jLabelNumEmbarazo.setText("Nº Embarazo :");
