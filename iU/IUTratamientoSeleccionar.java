...
public class IUTratamientoSeleccionar extends JFrame implements java.util.Observer{
	...
	private void ver(){
		...
		if(t != null){
			String respuesta = "";
			respuesta = JOptionPane.showInputDialog(this, "Está a punto de termi un tratamiento\n(Ingrese SI para eliminar) Confirmar: ", "Confirmar", 1);
			if(respuesta==null)respuesta="No";
			if(respuesta.equalsIgnoreCase("Si")){
				Date hoy = new Date();
				t.getFecha_fin().setTime(hoy);
				System.out.println(ManejoFechas.formatoEspanol.format(t.getFecha_inicio().getTime()));
				System.out.println(ManejoFechas.formatoEspanol.format(t.getFecha_fin().getTime()));
				Fachada.getInstancia().guardarTratamiento(t);
			}
		}
	}
