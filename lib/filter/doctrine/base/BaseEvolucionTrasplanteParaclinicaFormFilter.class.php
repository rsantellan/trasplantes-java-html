...
/**
 * EvolucionTrasplanteParaclinica filter form base class.
 *
 ...
 */
abstract class BaseEvolucionTrasplanteParaclinicaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ku'            => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'ku'            => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      ...
      'pthi'          => new sfValidatorChoice(array('required' => false, 'choices' => array('Ausente' => 'Ausente', 'Presente' => 'Presente', 'Falta' => 'Falta'))),
    ...
    $this->widgetSchema->setNameFormat('evolucion_trasplante_paraclinica_filters[%s]');
