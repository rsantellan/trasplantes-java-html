...
/**
 * Induccion filter form base class.
 *
 ...
 */
abstract class BaseInduccionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('induccion_filters[%s]');
  ...
  public function addTrasplanteListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('TrasplanteInduccion.trasplante_id', $values)
    ;
  }
