...
/**
 * TrasplanteComplicacionesNoInfecciosas filter form base class.
 *
 ...
 */
abstract class BaseTrasplanteComplicacionesNoInfecciosasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('trasplante_complicaciones_no_infecciosas_filters[%s]');
