...
abstract class BaseTrasplanteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'paciente_pre_trasplante_id'        => new sfWidgetFormFilterInput(array('with_empty' => false)),
      ...
      'numero_compabilidad_a_b'           => new sfWidgetFormFilterInput(),
      'numero_compabilidad_dr'            => new sfWidgetFormFilterInput(),
      'numero_incompatibilidad_a_b'       => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      'paciente_pre_trasplante_id'        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'id_donante'                        => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'numero_compabilidad_a_b'           => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'numero_compabilidad_dr'            => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'numero_incompatibilidad_a_b'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      'id'                                => 'Number',
      'paciente_pre_trasplante_id'        => 'Number',
      'fecha'                             => 'Date',
      ...
      'numero_venas'                      => 'Number',
      'ureter'                            => 'Text',
      'numero_compabilidad_a_b'           => 'Number',
      'numero_compabilidad_dr'            => 'Number',
      'numero_incompatibilidad_a_b'       => 'Number',
