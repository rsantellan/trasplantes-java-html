...
/**
 * Organos form base class.
 *
 * @method Organos getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseOrganosForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('organos[%s]');
