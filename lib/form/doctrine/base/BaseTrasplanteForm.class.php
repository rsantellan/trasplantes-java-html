...
abstract class BaseTrasplanteForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'paciente_pre_trasplante_id'        => new sfWidgetFormInputText(),
      ...
      'numero_compabilidad_a_b'           => new sfWidgetFormInputText(),
      'numero_compabilidad_dr'            => new sfWidgetFormInputText(),
      'numero_incompatibilidad_a_b'       => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'paciente_pre_trasplante_id'        => new sfValidatorInteger(),
      'fecha'                             => new sfValidatorDate(),
      'numero_de_transplantes_realizados' => new sfValidatorInteger(array('required' => false)),
      'id_donante'                        => new sfValidatorInteger(),
      ...
      'numero_compabilidad_a_b'           => new sfValidatorInteger(array('required' => false)),
      'numero_compabilidad_dr'            => new sfValidatorInteger(array('required' => false)),
      'numero_incompatibilidad_a_b'       => new sfValidatorInteger(array('required' => false)),
