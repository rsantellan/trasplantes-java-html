...
public class BrkPerdidaInjerto extends Broker {
	...
	public String getInsertSQL() {
		...
		sql = "INSERT INTO paciente_perdida_injerto(THE,CAUSA,FECHA_PERDIDA) VALUES ("+p.getThe()+","+ p.getNumCausa() +",'"+fecha +"')";
		return sql;
	}
	...
	public String getUpdateSQL() {
		PacientePerdidaInjerto p = (PacientePerdidaInjerto) this.getObj();
		String sql = "UPDATE paciente_perdida_injerto SET CAUSA ="+ p.getNumCausa();
