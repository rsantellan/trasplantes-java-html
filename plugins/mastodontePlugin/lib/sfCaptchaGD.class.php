...
class sfCaptchaGD 
{
  ...
  function __construct() {
      ...
      $this->rotate_min = sfConfig::get('app_sf_captchagd_rotate_min', -25);
      $this->rotate_max = sfConfig::get('app_sf_captchagd_rotate_max', 25);
			$this->background_drow_lines = sfConfig::get('app_sf_captchagd_background_drow_lines', false);
  }
  ...
  public function generateImage($securityCode = NULL)
  {
    ...
    // create random lines over text
		if($this->background_drow_lines !== false){
    ...
    for ($i = 0; $i < strlen($newstr); $i++) {
        ...
        // randomize rotation
        $rotate = rand($this->rotate_min, $this->rotate_max);
