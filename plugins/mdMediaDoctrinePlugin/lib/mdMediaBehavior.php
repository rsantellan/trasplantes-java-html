...
class mdMediaBehavior extends Doctrine_Template
{
    ...
    public function retrieveAvatar($options = array('width' => 46,'height' => 46), $type = mdMediaAlbum::MIXED)
    {
        try
        {
            ...
            {
                return mdWebImage::getUrl($this->getInvoker()->retrieveDefault(), $options);//$this->getInvoker()->retrieveDefault(); // mdWebImage::getUrl($this->getInvoker()->retrieveDefault(), $options);//$this->getInvoker()->retrieveDefault();
            }
            ...
            return mdWebImage::getUrl($this->getInvoker()->retrieveDefault(), $options);
