...
<div id="md_draggable_<?php echo $mediaConcrete->getObjectClass(); ?>_<?php echo $mediaConcrete->getId() ?>_<?php echo $album_id; ?>_<?php echo $object->getId() ?>_<?php echo $object->getObjectClass(); ?>" class="<?php if(($i % 4 == 0)): echo 'no_marginr'; endif; ?> md_draggable small_avatar_block">
    ...
    <img title="<?php echo $mediaConcrete->getName(); ?>" style="margin-right: 2px; margin-bottom: 2px;" src="<?php echo $mediaConcrete->getUrl(array(mdWebOptions::WIDTH => 68, mdWebOptions::HEIGHT => 68, mdWebOptions::EXACT_DIMENTIONS => true, mdWebOptions::CODE => mdWebCodes::RESIZECROP)); ?>" width="68" height="68" alt="" />
