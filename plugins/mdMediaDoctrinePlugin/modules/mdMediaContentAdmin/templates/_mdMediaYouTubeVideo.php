...
<div style="float: left;" id="md_draggable_<?php echo $mediaConcrete->getObjectClass(); ?>_<?php echo $mediaConcrete->getId() ?>_<?php echo $album_id; ?>_<?php echo $object->getId() ?>_<?php echo $object->getObjectClass(); ?>" class="<?php if(($i % 5 == 0)): echo 'no_marginr'; endif; ?> md_draggable">
    <div class="box_pdf">
        ...
        <!--<div style="position: absolute; width: 20px; height: 20px; margin-top: 47px;">
          <img width="20" height="20" src="/mastodontePlugin/images/play_small.png" />
        </div>-->
        <img style="margin-right: 2px;" src="<?php echo $mediaConcrete->getObjectUrl(); ?>" width="68" height="68" title="<?php echo $mediaConcrete->getName(); ?>" alt="" />
