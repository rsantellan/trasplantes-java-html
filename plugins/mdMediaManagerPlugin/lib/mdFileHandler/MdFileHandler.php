...
class MdFileHandler {
    ...
    public static $whiteList = array ('jpg', 'jpeg', 'gif', 'png', 'pdf', 'doc', 'docx', 'xls', 'ppt', 'xlsx', 'pptx', 'flv');
                    ...
                    if (is_dir($path . $file) AND $file != '.' AND $file != '..' AND $file != '.svn'){
                       ...
                       self::getList($path . $file . "/");
                        ...
                        if($file != '.' AND $file != '..' AND $file != '.svn'){
                            $imageFile = new mdImageFile($path . $file);
                            if($imageFile->validImage()){
                                array_push($array, $imageFile);
                            }
                        }
