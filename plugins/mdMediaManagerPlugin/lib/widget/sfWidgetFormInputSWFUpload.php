...
class sfWidgetFormInputSWFUpload extends sfWidgetFormInputFile
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('swfupload_upload_url', $this->options_data['widget']['upload_url']);
    $this->addOption('swfupload_post_name', null);
    $this->addOption('swfupload_post_params', $this->options_data['widget']['post_params']);

    $this->addOption('swfupload_file_types', $this->options_data['widget']['file_types']);
    $this->addOption('swfupload_file_types_description', 'Web images');

    $this->addOption('swfupload_file_size_limit', ini_get($this->options_data['widget']['max_filesize']));
    ...
    $this->addOption('swfupload_flash_url',     public_path('/mdMediaManagerPlugin/js/vendor/swfupload/swfupload/swfupload.swf'));

    $this->addOption('swfupload_css_path',      public_path('/mdMediaManagerPlugin/css/swfupload.css'));
    $this->addOption('swfupload_js_lib',        public_path('/mastodontePlugin/js/jquery-ui-1.8.4/js/jquery-1.4.2.min.js'));
    $this->addOption('swfupload_js_path',       public_path('/mdMediaManagerPlugin/js/vendor/swfupload/swfupload/swfupload.js'));
    $this->addOption('swfupload_progress_path', public_path('/mdMediaManagerPlugin/js/'.$this->options_data['widget']['progress_style'].'.js'));
    $this->addOption('swfupload_handler_path',  public_path('/mdMediaManagerPlugin/js/swfupload-widget-handler.js'));
    $this->addOption('swfupload_plugins_dir',   public_path('/mdMediaManagerPlugin/js/vendor/swfupload/plugins'));
    ...
    $this->addOption('swfupload_get_browse_button_element', $this->options_data['widget']['upload_browse']);    
  }

  public function __construct($options = array(), $attributes = array(), $options_data = array()){
  ...
  {
    $js = array(
      $this->getOption('swfupload_js_lib'),
      $this->getOption('swfupload_js_path'),
      $this->getOption('swfupload_progress_path'),
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    $output = <<<EOF
      ...
      {$this->getOption('swfupload_get_browse_button_element')}
        ...
        SWFUpload.onload = function()
        {
          ...
          ({
            ...
            custom_settings :
            {
              ...
              progressTarget: "uploaded-files-container"
            },
