...
//	public function retrieveAllOtherMdUserProfilesOfApplication($mdUserProfile, $mdApplicationId){
//		    $query = Doctrine_Query::create ()
//                        ->select ('mdP.*')
//                        ->from ('mdUserProfile mdP, mdContent mdC, mdContentApplication mdCA')
//                        ->where ('mdC.object_id = mdP.id')
//                        ->addWhere('mdC.object_class = ?', "mdUserProfile")
//                        ->addWhere('mdP.id != ?', $mdUserProfile)
//                        ->addWhere ('mdC.id = mdCA.md_content_id')
//                        ->addWhere('mdCA.application_id = ?', $mdApplicationId);
//
//            return $query->execute ();
//	}
//
//        public function retrieveAllMdUserProfilesOfApplication($mdUserProfile, $mdApplicationId){
//		    $query = Doctrine_Query::create ()
//                        ->select ('mdP.*')
//                        ->from ('mdUserProfile mdP, mdContent mdC, mdContentApplication mdCA')
//                        ->where ('mdC.object_id = mdP.id')
