...
mdUserManagement.prototype = {
    ...
    changeMdPassportActivation: function(mdPassportId, mdApplicationId){
        var url = $('#add_applications_of_passport').attr('urlToGo');
        $.ajax({
            url: url,
            data: {'mdPassportId': mdPassportId, 'mdApplicationId': mdApplicationId},
            type: 'post',
            dataType: 'json',
    ...
    changeMdUserSuperAdmin: function(mdUserId){
        var url = 'mdUserManagement/switchMdUserSuperAdmin';
    ...
    addNewProfileToUser: function(passportId, mdUserId, url){
        //ver esto como ajustarlo a jquery
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(json){
                $('#new_product_' + mdUserId).html(json);
                $('#new_product_' + mdUserId).slideDown(1000);
            }
        });
    ...
    saveNewProfile: function(mdUserId)
    {
        ...
        $.ajax({
            ...
            success: function(json){
                ...
                {
                    $('#profile_form_').html(json.options.body);
                     AjaxLoader.getInstance().hide();
                }
            }
        });
