...
public class IUManejarSerolDatos extends JFrame implements java.util.Observer {
	...
	private void modificar(){
		...
		if(sd!= null){
			JOptionPane.showMessageDialog(this,"Todos los trasplantes que esten asociados con este serol se veran afectados" , "Atencion", 2);
			String nueva = "";
	...
	private void eliminar(){
		...
		if(sd!= null){
			String respuesta = "";
			respuesta = JOptionPane.showInputDialog(this, "Est� a punto de eliminar un Dato de serol\n(Ingrese SI para eliminar) Confirmar: ", "Confirmar", 1);
