...
import iu.windows.logic.IUPrincipalLogic;
...
public class IUPrincipal extends JFrame implements java.util.Observer {
	...
	private void reporteConsultaUrologica(){
		JOptionPane.showMessageDialog(this,
				"Por favor espere hasta que aparezca la confirmacion que el proceso termino",
				"Proceso iniciado", JOptionPane.PLAIN_MESSAGE);
		ConsultaUrologicaExcel consulta = new ConsultaUrologicaExcel();
		consulta.crear();
		JOptionPane.showMessageDialog(this,
				"Documentacion terminada",
				"Proceso terminado", JOptionPane.OK_OPTION);
	}
 ...
 * @return javax.swing.JMenuItem	
 */
private JMenuItem getJMenuItemConsultaUrologicaTotal() {
	if (jMenuItemConsultaUrologicaTotal == null) {
		jMenuItemConsultaUrologicaTotal = new JMenuItem();
		jMenuItemConsultaUrologicaTotal.setText("Reporte de Consulta Urologica");
		jMenuItemConsultaUrologicaTotal
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent e) {
						reporteConsultaUrologica();
					}
				});
	}
