...
public class ControlConsultas {
	...
	public Generico consultaPacientesTabaquismo() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, PP.TABAQUISMO FROM pacientes P, pacientepretrasplante PP, trasplante T";
	...
	public Generico consultaPacientesDislipemia() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, PP.DISLIPEMIA FROM pacientes P, pacientepretrasplante PP, trasplante T";
	...
	public Generico consultaIMCPacientesConObesidad() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, PP.OBESIDAD, PP.IMC FROM pacientes P, pacientepretrasplante PP, trasplante T";
	...
	public Generico consultaPacientesConHta() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, PP.HTA FROM pacientes P, pacientepretrasplante PP, trasplante T";
	...
	public Generico consultaPacientesConDiabetes() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, PP.DIABETES FROM pacientes P, pacientepretrasplante PP, trasplante T";
	...
	public Generico consultaPacientesPorOrigen() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, PP.ORIGEN FROM pacientes P, pacientepretrasplante PP, trasplante T";
	...
	public Generico consultaPacientesPorEdad() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, P.FECHA_NACIMIENTO, T.fecha ,";
	...
	public Generico consultaPacientesTiempoEnLista() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, PP.FECHA_INGRESO_LISTA ,T.fecha,";
	...
	public Generico consultaPacientesNefropatiasPBR() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, N.NEFROPATIA, PP.PBR";
	...
	public Generico consultaTranfusionesEmbarazos() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, T.TRANS_PREVIAS,T.NUM_TRANSF, T.EMBARAZO, T.NUM_EMBARAZO";
		sql += " FROM pacientes P, pacientepretrasplante PP, trasplante T";
	...
	public Generico consultaTipoSangrePacienteDonante() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, P.GRUPO_SANG, D.ID, D.GRUPO_SANG";
	...
	public Generico consultaNumArteriasVenasYUreter() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, T.NUM_ART, T.NUM_VENAS, T.URETER";
		sql += " FROM pacientes P, pacientepretrasplante PP, trasplante T";
		...
		g.getListaNombre().add("NOMBRE");
		g.getListaNombre().add("APELLIDO");
		g.getListaNombre().add("Num ARTERIAS");
		g.getListaNombre().add("Num VENAS");
	...
	public Generico consultaLadoRinhonAnomalia() {
		String sql = "SELECT P.THE, T.pretrasplante,  P.NOMBRE, P.APELLIDO, T.RINHON, T.ANOMALIA_VASC";
		sql += " FROM pacientes P, pacientepretrasplante PP, trasplante T";
		sql += " WHERE P.the = PP.the AND PP.id = T.pretrasplante ORDER BY P.THE";
		Generico g = new Generico();
		g.setSql(sql);
	...
	public Generico consultaDonanteCausaMuerte(int idCausa) {
		String sql = "SELECT P.THE,T.pretrasplante, P.NOMBRE, P.APELLIDO, D.ID, DCM.DETALLES";
	...
	public Generico consultaPacienteInastabilidadHemodinamica() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, T.INESTAB_HEMOD";
		sql += " FROM pacientes P, pacientepretrasplante PP, trasplante T";
	...
	public Generico consultaPacienteEdadDonanteEdad() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO,";
		sql += " (YEAR(fecha) - YEAR(FECHA_NACIMIENTO))- IF(RIGHT(fecha,5) < RIGHT(FECHA_NACIMIENTO,5),1,0) AS age,";
	...
	public Generico consultaSexoPacienteDonante() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, P.SEXO, D.ID, D.SEXO_DONANTE";
		sql += " FROM pacientes P, pacientepretrasplante PP, trasplante T, donante D";
		sql += " WHERE P.the = PP.the AND PP.id = T.pretrasplante AND T.ID_DONANTE = D.ID";
		Generico g = new Generico();
		g.setSql(sql);
	...
	public Generico consultaTipoDonantePaciente() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, D.ID, D.TIPO_DONANTE, D.RELACION_FILIAR";
		sql += " FROM pacientes P, pacientepretrasplante PP, trasplante T, donante D";
		sql += " WHERE P.the = PP.the AND PP.id = T.pretrasplante AND T.ID_DONANTE = D.ID";
		Generico g = new Generico();
		g.setSql(sql);
	...
	public Generico consultaPacienteVariosTrasplantes() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, T.NUM_TR";
		sql += " FROM pacientes P, pacientepretrasplante PP, trasplante T";
	...
	public Generico consultaPacienteFechaTrasplantes() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, T.FECHA";
		sql += " FROM pacientes P, pacientepretrasplante PP, trasplante T";
		sql += " WHERE P.the = PP.the AND PP.id = T.pretrasplante";
		Generico g = new Generico();
		g.setSql(sql);
	...
	public Generico consultaTrasplantesCompatibilidadIncompatibilidadPRA() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, T.NUM_COMP_A_B, T.NUM_COMP_DR,";
	...
	public Generico consultaTrasplantesPorCirugia() {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, T.TQ_DE_BANCO, T.LADO_IMPLANTE,";
	...
	public Generico consultaTrasplantesIsquemiaDiuresis(boolean diuresis) {
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, T.T_ISQ_CAL_MIN, T.T_ISQ_FRIA_HS,";
	...
	public Generico consultaPacientesComplicacionesInfecciosasEntreFechas(
			int desde, int hasta, int tipo) {
		if (desde > hasta)
			return new Generico();
		if (tipo != 1 && tipo != 2 && tipo != 3)
			return new Generico();
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, M.NOMBRE, I.NOMBRE, G.NOMBRE ";
		...
		case 1:
			sql += "ADDDATE(T.fecha,INTERVAL " + desde
					+ " MONTH) <= TC.fecha and ADDDATE(T.fecha,INTERVAL "
					+ (hasta) + " MONTH) >= TC.fecha";
			break;
		case 2:
			sql += "ADDDATE(T.fecha,INTERVAL " + desde
					+ " DAY) <= TC.fecha and ADDDATE(T.fecha,INTERVAL "
		...
		case 3:
			sql += "ADDDATE(T.fecha,INTERVAL " + desde
					+ " YEAR) <= TC.fecha and ADDDATE(T.fecha,INTERVAL "
					+ (hasta) + " YEAR) >= TC.fecha";
			break;
		default:
			break;
	...
	public Generico consultaPacientesComplicacionesNoInfecciosasEntreFechas(
			int desde, int hasta, int tipo) {
		if (desde > hasta)
			return new Generico();
		if (tipo != 1 && tipo != 2 && tipo != 3)
			return new Generico();
		String sql = "SELECT P.THE, T.pretrasplante, P.NOMBRE, P.APELLIDO, M.NOMBRE, CT.TIPO, CT.NOMBRE ";
	...
	public Generico consultaPacientesComplicacionesInfecciosasDetalles(
			int desde, int hasta, int tipo, int the) {
		if (desde > hasta)
			return new Generico();
		if (tipo != 1 && tipo != 2 && tipo != 3)
			return new Generico();
		...
		sql += " and P.the = " + the;
		sql += " AND ";// "ADDDATE(t.fecha,INTERVAL " + desde +
						// " MONTH) <= TC.fecha and ADDDATE(t.fecha,INTERVAL " +
						// hasta + " MONTH) >= TC.fecha";
		switch (tipo) {
		case 1:
	...
	public Generico consultaPacientesComplicacionesNoInfecciosasDetalles(
			int desde, int hasta, int tipo, int the) {
		if (desde > hasta)
			return new Generico();
		if (tipo != 1 && tipo != 2 && tipo != 3)
