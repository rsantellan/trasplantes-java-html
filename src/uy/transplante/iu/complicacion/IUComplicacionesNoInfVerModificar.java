...
public class IUComplicacionesNoInfVerModificar extends JFrame {
	...
	private TrasplanteComplicacionesNoInf complicacion;
	private boolean ver;
	 ...
	 */
	public IUComplicacionesNoInfVerModificar(TrasplanteComplicacionesNoInf complicacion, boolean ver) {
		super();
	...
	private void cargarComplicacion(){
		...
		this.jComboBoxTipo.setSelectedItem(this.complicacion.getComplicacion());
	...
	private void cargarDatos(){
		...
		ArrayList<TrasplanteTiposComplicaciones> tipos = Fachada.getInstancia().obtenerTodosTiposComplicaciones();
	...
	private JButton getJButtonSalir() {
		if (jButtonSalir == null) {
			...
			jButtonSalir.setBounds(new Rectangle(16, 339, 116, 36));
	...
	private JButton getJButtonGuardar() {
		if (jButtonGuardar == null) {
			...
			jButtonGuardar.setBounds(new Rectangle(283, 339, 116, 36));
	...
	private JDesktopPane getJDesktopPaneObservaciones() {
		if (jDesktopPaneObservaciones == null) {
			...
			jDesktopPaneObservaciones.setBounds(new Rectangle(18, 223, 381, 108));
