...
public class IUManejarCausaMuerteDonante extends JFrame implements java.util.Observer {
	...
	public void update(Observable o, Object arg) {
		if(Fachada.getInstancia().getLugar() == Fachada.CAUSA_MUERTE_DONANTE){
			this.cargarDatos();
		}
	}
	...
	private void modificar(){
		...
		if(a!= null){
			JOptionPane.showMessageDialog(this,"Todos los Donante relacionados con esta Causa de Muerte pasaran a estar relacionados con la nueva" , "Atencion", 2);
			String nueva = "";
	...
	private void eliminar(){
		...
		if(c!= null){
			String respuesta = "";
			respuesta = JOptionPane.showInputDialog(this, "Está a punto de eliminar una Causa de Muerte de Donante\n(Ingrese SI para eliminar) Confirmar: ", "Confirmar", 1);
