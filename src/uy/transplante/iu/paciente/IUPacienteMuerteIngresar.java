...
public class IUPacienteMuerteIngresar extends JFrame implements java.util.Observer{
	...
	public void update(Observable arg0, Object arg1) {
		...
		if(o==Fachada.getInstancia()){
			if(Fachada.getInstancia().getLugar() == Fachada.MUERTE_PACIENTE){
				this.cargarDatos();
			}
		}
	}
	...
	private void confirmar(){
		...
		if(this.miPaciente.getListaPreTrasplantes().size() == 0){
			IUAuxiliarPaneles.jOptionMessageDialog(this, "No existe un transplante asociado.", "Error",IUAuxiliarPaneles.error);
			return;
		}
		if(jDateChooserMuerte.getCalendar() == null){
			IUAuxiliarPaneles.jOptionMessageDialog(this, "Tiene que ingresar la fecha de fallecimiento.", "Falta información",IUAuxiliarPaneles.error);
		}else{
