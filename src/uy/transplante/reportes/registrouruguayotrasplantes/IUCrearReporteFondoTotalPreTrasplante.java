...
public class IUCrearReporteFondoTotalPreTrasplante extends JFrame {
	 ...
	 */
	public IUCrearReporteFondoTotalPreTrasplante() {
		super();
		initialize();
	}
	...
	private void crear(){
		CrearReporteFondoPreTrasplante_RA_CMV reporte = new CrearReporteFondoPreTrasplante_RA_CMV();
	...
	private class Ejecutor implements Runnable{
		...
		CrearReporteFondoPreTrasplante_RA_CMV c;
		public Ejecutor(CrearReporteFondoPreTrasplante_RA_CMV c){
			this.c = c;
		}
	...
	private class Verificador implements Runnable{
		...
		CrearReporteFondoPreTrasplante_RA_CMV c;
		public Verificador(CrearReporteFondoPreTrasplante_RA_CMV c){
			this.c = c;
		}
