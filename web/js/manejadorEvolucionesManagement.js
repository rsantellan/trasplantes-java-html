...
manejadorEvolucionesManagement.prototype = {
        ...
        $.ajax({
            ...
            success: function(json){
                if(json.response == "OK")
                {
                    if(json.options.isnew == true)
                    {
                        $("#evolucion_examen_ul").append(json.options.body);
                      
                    }
                    else
                    {
                        $('#examen_li_'+json.options.id).replaceWith(json.options.body);
                    }
                    manejadorEvolucionesManagement.getInstance().refreshFancyLinks();
                    $.fancybox.close();
                }
                ...
                {
                    $("#evolucion_examen_new_container").replaceWith(json.options.body);
                }
    ...
    deleteExamen: function(id, text, url)
    {
        if(confirm(text))
        {
            $.fancybox.showActivity();
            $.ajax({
                ...
                success: function(json){
                    if(json.response == "OK")
                    {
                        $('#examen_li_'+json.options.id).remove();
                        $.fancybox.close();
                    }
                    else
                    {
